"""MQTT Serverless 保活脚本：连接 Broker，向主题发布消息并订阅同一主题验证回包。"""
import os
import random
import sys
import threading
...
def main():
    ...
    client = mqtt.Client(mqtt.CallbackAPIVersion.VERSION2, client_id='github-keepalive-' + str(random.randint(1000, 9999)))
    if username:
